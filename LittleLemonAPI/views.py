...
from .serializers import CategorySerializer, UserSerializer, CartSerializer, MenuItemSerializer, OrderSerializer, OrderItemSerializer
...
class SinlgeOrderView(generics.RetrieveUpdateAPIView):
